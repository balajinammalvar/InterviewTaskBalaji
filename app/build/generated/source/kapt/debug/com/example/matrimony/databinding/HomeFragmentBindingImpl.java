...
public class HomeFragmentBindingImpl extends HomeFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivMore, 2);
        sViewsWithIds.put(R.id.tvRecommendation, 3);
        sViewsWithIds.put(R.id.rvHomeScreen, 4);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.matrimony.model.MatrimonyData) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.example.matrimony.model.MatrimonyData Viewmodel) {
